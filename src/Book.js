...
const Book = (props) => (
    <div className="book">
        ...
        <div className="book-cover" style={{ width: 128, height: 188,  backgroundImage: props.book.imageLinks !== undefined ? `url(${props.book.imageLinks.thumbnail})` : '' }}></div>
        <div className="book-shelf-changer">
            ...
            <option selected={props.book.shelf === undefined || props.book.shelf === "none"} value="none">None</option>
            </select>
        </div>
        </div>
